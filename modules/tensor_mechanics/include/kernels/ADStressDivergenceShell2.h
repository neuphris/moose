...
/**
 * ADStressDivergenceShell2 computes the stress divergence term for shell elements.
 **/

class ADStressDivergenceShell2 : public ADKernel
{
public:
  static InputParameters validParams();

  ADStressDivergenceShell2(const InputParameters & parameters);
...
protected:
  ...
  std::vector<const ADMaterialProperty<Real> *> _gamma_x;
  std::vector<const ADMaterialProperty<Real> *> _gamma_y;
  std::vector<const ADMaterialProperty<Real> *> _gamma_z;

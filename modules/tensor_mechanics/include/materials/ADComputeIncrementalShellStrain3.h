...
class ADComputeIncrementalShellStrain3 : public Material
{
public:
  static InputParameters validParams();

  ADComputeIncrementalShellStrain3(const InputParameters & parameters);
...
protected:
  ...
  ADMaterialProperty<RealVectorValue> & _v1;
  ADMaterialProperty<RealVectorValue> & _v2;
  const MaterialProperty<RealVectorValue> & _v1_old;
  const MaterialProperty<RealVectorValue> & _v2_old;
